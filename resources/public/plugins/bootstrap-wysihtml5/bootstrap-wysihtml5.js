!function($, wysi) {
    ...
    var tpl = {
		...
		"<li><div class='wysihtml5-colors' data-wysihtml5-command-value='staples_red'></div><a class='wysihtml5-colors-title' data-wysihtml5-command='foreColor' data-wysihtml5-command-value='staples_red'>" + locale.colours.staples_red + "</a></li>" +
              "</ul>" +
            "</li>";
        }
    };
